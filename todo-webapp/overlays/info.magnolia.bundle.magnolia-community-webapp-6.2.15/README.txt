...
This package contains:
   ...
   Magnolia Core 6.2.15
   Magnolia empty webapp 6.2.15
   Magnolia empty webapp 6.2.15
   Magnolia Internationalization Framework 6.2.15
   Magnolia JAAS 6.2.15
   Magnolia Mail module 5.5.9
   magnolia-module-rssaggregator 2.6.4
   Magnolia Rendering 6.2.15
   Magnolia Templating 6.2.15
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/6.2.15.html
